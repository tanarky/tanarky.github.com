...
<link rel='stylesheet' href='${bf.config.css_dir}/pygments_${bf.config.filters.syntax_highlight.style}.css' type='text/css' />

<link rel='stylesheet' href='${bf.config.css_dir}/bootstrap.1.3.0.min.css' type='text/css' />
